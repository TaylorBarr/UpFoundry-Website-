...
//DATABASE CONNECTION
define('DB_NAME', 'uptaylor_solo');
define('DB_USER', 'uptaylor_me');
define('DB_PASSWORD', 'washburn1984');
define('DB_HOST', 'localhost');

//BASE URL
$CONFIG['base_url'] = 'http://pm.upfoundry.com/';
...
$CONFIG['company']['phone'] = '919-410-8540';
$CONFIG['company']['website'] = 'www.upfoundry.com';
