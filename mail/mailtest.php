<?php
	...
	$transport = Swift_SmtpTransport::newInstance('smtp.gmail.com', 587, 'tls' )
	  ->setUsername('taylor@upfoundry.com')     
	  ->setPassword('hpghgghenzkhtzdr')
	  ;
	...
	// Creating the message text using fields sent through POST
		...
		$messageText = 'Test message body';
	
	
	
	
	// You can change "A message from Pivot Template Form" to your own subject if you want.
	$message = Swift_Message::newInstance('Lets Talk | Upfoundry.com')
	  ->setFrom(array('taylor@upfoundry.com' => 'salman');
	  ->setTo(array('salmaniz.82@gmail.com' => 'UpFoundry Website'))->setBody($messageText);
//                           ^                    ^
