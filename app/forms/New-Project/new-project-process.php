...
if( isset($_POST['name']) )
{
	...
	$mail->Subject = 'Form: New Request for Website'; // Replace with your subject if you need
	...
	$mail->Body = 'Name: ' . $_POST['name'] . "\n" .
						 ...
						 'E-mail: ' . $_POST['email']. "\n" .
						 'Phone: ' . $_POST['phone']. "\n\n" .
						 'New/Old Website: ' . $_POST['website']. "\n" .
						 'Website-URL ' . $_POST['website-URL']. "\n" .
						 'Need Web Hosting: ' . $_POST['web-hosting']. "\n" .
						 'Pages Needed? '. $allcd = implode(", ", $_POST['pages']). "\n" .
						 'Budget: ' . $_POST['budget']. "\n" .
