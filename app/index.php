...
<head>
 ...
 More info: h5bp.com/b/378 -->
    ...
    <title>Up Foundry Central: Login to Dashboard </title>
    <meta name="description" content="Login to the The Up Foundry Control Panel">
    ...
    <link rel="stylesheet" type="text/css" href="client/plugins/3rd-party/chartist/chartist.min.css">
    <link rel="stylesheet" type="text/css" href="client/plugins/3rd-party/fullcalendar-2.4.0/fullcalendar.css">
    <link rel="stylesheet" type="text/css" href="client/plugins/3rd-party/select2-4.0.0/dist/css/select2.min.css">
...
<script defer src="client/js/libs/jquery-ui-1.11.4.custom.min.js"></script>
<script defer type="text/javascript" src="https://js.stripe.com/v1/"></script>

<!-- scripts concatenated and minified via build script -->

<script defer src="client/plugins/3rd-party/select2-4.0.0/dist/js/select2.full.min.js"></script>
...
<script defer src='client/plugins/3rd-party/fullcalendar-2.4.0/fullcalendar.js'></script>
...
<!-- Chartist -->
<script defer src="client/plugins/3rd-party/chartist/chartist.min.js"></script>
