...
$CONFIG['base_url'] = 'https://app.upfoundry.com/';
...
$CONFIG['email']['host'] = 'mail.upfoundry.com';

$CONFIG['email']['port'] = 26;

$CONFIG['email']['enable_authentication'] = true;

$CONFIG['email']['username'] = 'messages@upfoundry.com';

$CONFIG['email']['password'] = 'washburn1984';
...
$CONFIG['incoming_email']['email_address'] = 'theupfoundry@gmail.com';

$CONFIG['incoming_email']['host'] = 'imap.gmail.com';

$CONFIG['incoming_email']['port'] = 993;

$CONFIG['incoming_email']['password'] = 'giantsteps';

$CONFIG['estimates']['post_processing'] = 'generate_invoice';
...
//Setting file created Apr 8 2016 - 1:51 pm
