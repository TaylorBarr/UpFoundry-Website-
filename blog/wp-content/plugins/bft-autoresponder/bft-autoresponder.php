...
/*  Copyright 2012 - 2016  Kiboko Labs
...
function bft_init() {
   ...
   if(!defined('BFT_SENDER')) define('BFT_SENDER',get_option( 'bft_sender' ));
	...
	add_action( 'ninja_forms_post_process', array('BFTIntegrations', 'ninja_signup') );
...
function bft_autoresponder_menu() {  
  ...
  add_submenu_page('bft_options',__('Integrate in Ninja Form', 'broadfast'), __('Integrate in Ninja Form', 'broadfast'), 'manage_options', "bft_integrate_ninja", array("BFTIntegrations", "ninja"));
