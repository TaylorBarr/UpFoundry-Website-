	...
	<div class="postbox-container" style="width:73%;margin-right:2%;">	
			...
			<div style="width:500px;float:left;padding:10px;">
				...
				<div id="subscribeNotify" style="display:<?php echo $subscribe_notify ? 'block' : 'none';?>">
					[<a href="admin.php?page=bft_messages_config&msg=subscribe_notify"><?php _e('Configure this message', 'broadfast')?></a>]				
				</div>
				...
				<div id="unsubscribeNotify" style="display:<?php echo $unsubscribe_notify ? 'block' : 'none';?>">
					[<a href="admin.php?page=bft_messages_config&msg=unsubscribe_notify"><?php _e('Configure this message', 'broadfast')?></a>]				
				</div>
			...
			<div style="width:400px;float:left;padding:10px;">
				...
				<p><?php _e('Wordpress shortcode:', 'broadfast')?> <input type="text" value="[BFTWP]" onclick="this.select();" readonly="readonly" size="8"> <?php _e('Place it inside a post or page.', 'broadfast')?></p>				
				...
				<p align="center"><a href="admin.php?page=bft_integrate_ninja"><?php _e('Integrate in Ninja Form', 'broadfast');?></a></p>
			</div>
