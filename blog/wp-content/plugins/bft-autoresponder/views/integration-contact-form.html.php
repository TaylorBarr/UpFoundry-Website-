<div class="wrap">
	...
	<table cellspacing="10">
		<tr><td width="50%" valign="top">
			...
			<h3><?php printf(__('In the <a href="%s" target="_blank">PRO Version</a> you can also include all custom fields directly in your contact form.', 'broadfast'), 'http://calendarscripts.info/bft-pro/')?>	</h3>		
		</td></tr>	
	</table>	 
</div>